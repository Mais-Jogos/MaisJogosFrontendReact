            ...
            <div className="cadastroJogo__content__requirements__selected">
                ...
                <div className="cadastroJogo__content__requirements__inputs">
                    ...
                    <input type="text"
                        ...
                        value={requisitos.so}
                        aria-label={typeOfSO + " " + props.minimoOuRecomendado + " Sistema operacional"}
                ...
                <div className="cadastroJogo__content__requirements__inputs">
                    ...
                    <input
                        ...
                        aria-label={typeOfSO + " " + props.minimoOuRecomendado + " processador"}
                ...
                {!isPhone ? (<div className="cadastroJogo__content__requirements__inputs">
                    ...
                    <input
                        ...
                        aria-label={typeOfSO + " " + props.minimoOuRecomendado + " placa de vídeo"}
                ...
                <div className="cadastroJogo__content__requirements__inputs--select">
                    ...
                    <div>
                        <input type="number" id={"memoria" + labelId}
                            ...
                            aria-label={typeOfSO + " " + props.minimoOuRecomendado + " quantidade de memória"}
                        ...
                        <select name="memoriaQTD" id={"memoriaQTD" + labelId} aria-label={typeOfSO + " " + props.minimoOuRecomendado + " " + requisitos.memoria[1]}
                ...
                <div className="cadastroJogo__content__requirements__inputs--select">
                    ...
                    <div>
                        <input
                            ...
                            min={1}
                            aria-label={typeOfSO + " " + props.minimoOuRecomendado + " quantidade de armazenamento"}
                        ...
                        <select name="armazenamentoQTD" id={"armazenamentoQTD" + labelId} aria-label={typeOfSO + " " + props.minimoOuRecomendado + " " + requisitos.memoria[1]}
